...
import { getDocUri, activate, doc, editor } from "./helper";

suite("Should do completion", () => {
  const docUri = getDocUri("completion.qml");
  ...
  test("Completes with Rectangle component", async () => {
    await testCompletion(docUri, new vscode.Position(0, 0), {
      items: [
        ...
        { label: "Default", kind: vscode.CompletionItemKind.Module }, // TODO: Remover isso depois
